...
<script lang="ts">
  ...
  import MapConfig from "@/config/config_pgisls";
  ...
  export default class PluginTest extends Vue {
    private lsConfig = new MapConfig();
    private mapConfig = this.lsConfig.mapConfig;
    ...
    private async btn_backgroudGeometrySearch(){
      let map = this.$refs.gisViewer as any;
      const searchObj = {
        types:['alarmPoints','police'],
        geometry:[[102.269419,27.89324],
          [102.248578,27.885322],
          [102.251884,27.86859],
          [102.286091,27.87306],
          [102.286522,27.886216]
        ]
      }
      const result = await map.backgroundGeometrySearch(searchObj);
      console.log(result);
    }
