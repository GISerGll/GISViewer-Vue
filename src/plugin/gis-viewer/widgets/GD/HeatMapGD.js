...
export class HeatMapGD {
    ...
    async addHeatMap(params) {
        ...
        if (zoom > 0) {
            ...
            this.view.on('zoomend', (this.zoomEvent = (e) => {
    ...
    getHeatColor(colors) {
        ...
        if (colors && colors.length >= 4) {
            ...
            let step = (1 / colors.length).toFixed(2);
            let colorObj = {};
...
//# sourceMappingURL=HeatMapGD.js.map